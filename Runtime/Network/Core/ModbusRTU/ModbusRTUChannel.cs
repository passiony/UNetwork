...
namespace UNetwork
{
    ...
    /// </summary>
    public sealed class ModbusRTUChannel : AChannel
    {
        ...
        public ModbusRTUChannel(IPEndPoint ipEndPoint, ModbusRTUService tcpService) : base(tcpService, ChannelType.Connect)
        {
            this.memoryStream = tcpService.MemoryStreamManager.GetStream("message", ushort.MaxValue);

            this.socket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            this.socket.NoDelay = true;
            this.parser = new ModbusRTUParser(HeadSize, this.recvBuffer, this.memoryStream);
